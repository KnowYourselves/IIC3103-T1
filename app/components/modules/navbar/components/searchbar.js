...
const Searchbar = () => {
  ...
  return (
    <div className="relative w-full group sm:w-auto">
      <input
        className="w-full h-10 pl-5 pr-12 text-sm text-black bg-white border-green-100 rounded-lg sm:w-72 border-3 focus:ring-2 focus:outline-none dark:focus:ring-2 focus:ring-green-600 dark:focus:ring-gray-500"
        type="text"
        placeholder="Search"
        onKeyDown={onKeyDown}
        onChange={onChange}
